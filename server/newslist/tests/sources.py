...
class TestSources(unittest.TestCase):
    ...
    def test_get_article_lemonde_normal(self):
        ...
        self.assertEqual(result.image, "http://s2.lemde.fr/image/2016/02/01/534x0/4857146_4_214a_le-premier-ministre-belge-charles-michel-le-27_c269d14b5aaf17ab2c0d9c4a6999476b.jpg")
    ...
    def test_get_article_lemonde_blog(self):
        ...
        self.assertEqual(result.image, "http://ecologie.blog.lemonde.fr/files/2016/01/01-29-sharkeatingshark-01-1024x660.jpg")
    ...
    def test_get_article_lemonde_paywall(self):
        ...
        self.assertEqual(result.image, "http://s1.lemde.fr/image/2016/01/01/534x0/4840638_7_88c9_devant-le-restaurant-le-petit-cambodge-a_340b2fc82edc9f866d93da3d1debb028.jpg")
    ...
    def test_get_article_derstandard_normal(self):
        ...
        self.assertEqual(result.image, "http://images.derstandard.at/t/12/2016/01/31/zentralmaturaArtikelbild.jpg")
